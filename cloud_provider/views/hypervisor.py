...
"""
default_permission_content_type_name = "hypervisor"


class CustomResourceClassesList(ListAPIView):
...
class HypervisorInventoriesList(ListAPIView):
    permission_classes = [IsAuthenticated | HasAPIKey]
...
class HypervisorUsagesList(ListAPIView):
    permission_classes = [IsAuthenticated | HasAPIKey]
...
class HypervisorAllocationsList(ListAPIView):
    permission_classes = [IsAuthenticated | HasAPIKey]
