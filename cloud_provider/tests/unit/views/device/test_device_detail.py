...
class FlavourDeviceDetailViewTest(GenericApiViewTest):
    logger: logging.Logger = logging.getLogger(__name__)
    fixtures: list = []

    def setUp(self) -> None:
        super(FlavourDeviceDetailViewTest, self).setUp()
        ...
        self.url: str = "/v1.21.24/api/device/device_type_asd/device_ident_lel"
