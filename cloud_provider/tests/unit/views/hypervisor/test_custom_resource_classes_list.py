...
# forms test
class CustomResourceClassesListViewTest(GenericApiViewTest):
    logger: logging.Logger = logging.getLogger(__name__)

    def setUp(self) -> None:
        super(CustomResourceClassesListViewTest, self).setUp()
        ...
        self.url: str = "/v1.21.24/api/custom_resource_classes"
