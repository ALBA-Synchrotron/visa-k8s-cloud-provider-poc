...
# forms test
class HypervisorInventoriesListViewTest(GenericApiViewTest):
    logger: logging.Logger = logging.getLogger(__name__)

    def setUp(self) -> None:
        super(HypervisorInventoriesListViewTest, self).setUp()
        ...
        self.url: str = "/v1.21.24/api/hypervisor_inventories"
